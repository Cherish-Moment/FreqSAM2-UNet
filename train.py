...
from FreqSAM2UNet import SAM2UNet


parser = argparse.ArgumentParser("SAM2-UNet")
parser.add_argument("--hiera_path", type=str, help="path to the sam2 pretrained hiera")
parser.add_argument("--train_image_path", type=str, help="path to the image that used to train the model")
parser.add_argument("--train_mask_path", type=str, help="path to the mask file for training")
parser.add_argument('--save_path', type=str, help="path to store the checkpoint")
